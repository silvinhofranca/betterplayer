...
class BetterPlayerControlsConfiguration {
  ...
  const BetterPlayerControlsConfiguration({
    ...
    this.muteIcon = Icons.volume_up_rounded,
    this.unMuteIcon = Icons.volume_off_rounded,
    this.fullscreenEnableIcon = Icons.fullscreen_outlined,
    this.fullscreenDisableIcon = Icons.fullscreen_exit_outlined,
    this.skipBackIcon = Icons.replay_10_rounded,
    this.skipForwardIcon = Icons.forward_10_rounded,
    ...
    this.overflowMenuIcon = Icons.settings_rounded,
    this.pipMenuIcon = Icons.picture_in_picture_outlined,
    this.playbackSpeedIcon = Icons.speed_rounded,
    this.qualitiesIcon = Icons.hd_rounded,
    this.subtitlesIcon = Icons.closed_caption_rounded,
    this.audioTracksIcon = Icons.graphic_eq_rounded,
